...
const Socials = () => {
  ...
  <div className='flex items-center gap-x-5 text-lg'>
    ...
    <Link href={'https://drive.google.com/file/d/1RoCzFE_y4uMKWlEABFU25MGKsJTmCxj6/view?usp=sharing'} target='/blank' className='hover:text-accent transition-all duration-300'>
